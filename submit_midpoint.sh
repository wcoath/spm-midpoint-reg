...
#just while testing
ROOT_DIR=/SAN/medic/insight46/midpoint_test

#PRE-QSUB TEST, run script and line number to run
#DEBUG MODE PRE-QSUB: DON'T USE USUAL TEMP AND DON'T TRAP
#SCRATCH_DIR=${ROOT_DIR}/tmp/midpoint-$(date +%Y%m%d%H%M%S)
